...
var (
	...
	cacheMallUserUserCollectionIdPrefix           = "cache:mallUser:userCollection:id:"
	cacheMallUserUserCollectionUidProductIdPrefix = "cache:mallUser:userCollection:uid:productId:"
)
...
func (m *defaultUserCollectionModel) Delete(ctx context.Context, id int64) error {
	...
	mallUserUserCollectionIdKey := fmt.Sprintf("%s%v", cacheMallUserUserCollectionIdPrefix, id)
	mallUserUserCollectionUidProductIdKey := fmt.Sprintf("%s%v:%v", cacheMallUserUserCollectionUidProductIdPrefix, data.Uid, data.ProductId)
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
		return conn.ExecCtx(ctx, query, id)
	}, mallUserUserCollectionIdKey, mallUserUserCollectionUidProductIdKey)
	return err
}
...
func (m *defaultUserCollectionModel) FindOne(ctx context.Context, id int64) (*UserCollection, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, mallUserUserCollectionIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserCollectionModel) FindOneByUidProductId(ctx context.Context, uid int64, productId int64) (*UserCollection, error) {
	mallUserUserCollectionUidProductIdKey := fmt.Sprintf("%s%v:%v", cacheMallUserUserCollectionUidProductIdPrefix, uid, productId)
	var resp UserCollection
	err := m.QueryRowIndexCtx(ctx, &resp, mallUserUserCollectionUidProductIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserCollectionModel) Insert(ctx context.Context, data *UserCollection) (sql.Result, error) {
	mallUserUserCollectionIdKey := fmt.Sprintf("%s%v", cacheMallUserUserCollectionIdPrefix, data.Id)
	mallUserUserCollectionUidProductIdKey := fmt.Sprintf("%s%v:%v", cacheMallUserUserCollectionUidProductIdPrefix, data.Uid, data.ProductId)
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("insert into %s (%s) values (?, ?)", m.table, userCollectionRowsExpectAutoSet)
		return conn.ExecCtx(ctx, query, data.Uid, data.ProductId)
	}, mallUserUserCollectionIdKey, mallUserUserCollectionUidProductIdKey)
	return ret, err
}
...
func (m *defaultUserCollectionModel) Update(ctx context.Context, newData *UserCollection) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Uid, newData.ProductId, newData.Id)
	}, mallUserUserCollectionIdKey, mallUserUserCollectionUidProductIdKey)
	return err
}

func (m *defaultUserCollectionModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMallUserUserCollectionIdPrefix, primary)
}
